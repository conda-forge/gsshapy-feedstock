About gsshapy-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gsshapy-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/ci-water/gsshapy

Documentation: http://gsshapy.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2981&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gsshapy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gsshapy` can be installed with `conda`:
...
```
mamba install gsshapy
```

It is possible to list all of the versions of `gsshapy` available on your platform with `conda`:
...
```
mamba search gsshapy --channel conda-forge
```
...
mamba repoquery search gsshapy --channel conda-forge

# List packages depending on `gsshapy`:
mamba repoquery whoneeds gsshapy --channel conda-forge

# List dependencies of `gsshapy`:
mamba repoquery depends gsshapy --channel conda-forge
```
